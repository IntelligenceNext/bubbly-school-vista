...
create policy if not exists "Only administrators manage roles"
  on public.roles
  as restrictive
  for all
  to authenticated
...
create policy if not exists "Only administrators manage permissions"
...
create policy if not exists "Only administrators manage role_permissions"
...
create trigger if not exists set_roles_updated_at
