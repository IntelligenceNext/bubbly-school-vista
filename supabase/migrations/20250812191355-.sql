...
CREATE POLICY "Only administrators can insert role_permissions"
...
CREATE POLICY "Only administrators can update role_permissions"
ON public.role_permissions
AS RESTRICTIVE
FOR UPDATE
TO authenticated
...
CREATE POLICY "Only administrators can delete role_permissions"
ON public.role_permissions
AS RESTRICTIVE
FOR DELETE
TO authenticated
